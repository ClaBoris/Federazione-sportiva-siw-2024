...
public class AuthConfiguration {
	...
	protected SecurityFilterChain configure(final HttpSecurity httpSecurity)throws Exception{
		...
		.requestMatchers(HttpMethod.GET,"/", "/index", "/register", "/login", "/css/**", "/images/**", "favicon.ico","/presidenti","/giocatori").permitAll()
		...
		// solo gli utenti autenticati con ruolo PRESIDENT possono accedere a risorse con path /president/**
